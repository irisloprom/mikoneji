...
- Configure the API base URL in `src/config/api.ts` so your device/emulator can reach the backend (`10.0.2.2` for Android emulator, `localhost` for iOS simulator by default).
